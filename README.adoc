...
Because we are using https://github.com/facebook/react[React] for a significant portion of our UI rendering, we are unable to release Deck under
the Apache 2 license. Instead, it's released under a
https://github.com/spinnaker/deck/LICENSE.txt[BSD license] with an additional
https://github.com/spinnaker/deck/PATENT[patent grant].
