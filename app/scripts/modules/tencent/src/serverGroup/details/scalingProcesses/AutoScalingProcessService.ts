import { ITencentServerGroup, IScalingProcess } from 'tencent/domain';

export class AutoScalingProcessService {
  public static getDisabledDate(serverGroup: ITencentServerGroup): number {
  ...
  public static normalizeScalingProcesses(serverGroup: ITencentServerGroup): IScalingProcess[] {
  ...
  public static listProcesses(): IScalingProcess[] {
    return [
      ...
      },
      {
        name: 'AZRebalance',
        description:
          'Controls whether TENCENT should attempt to maintain an even distribution of instances across all ' +
