...
describe('Service: tencentServerGroup', function() {
  beforeEach(window.module(require('./serverGroupCommandBuilder.service').name));

  beforeEach(
    window.inject(function(_$httpBackend_, tencentServerGroupCommandBuilder, _instanceTypeService_, _$q_, $rootScope) {
      this.$httpBackend = _$httpBackend_;
      this.service = tencentServerGroupCommandBuilder;
      this.$q = _$q_;
  ...
  describe('buildServerGroupCommandFromPipeline', function() {
    beforeEach(function() {
      ...
      TencentProviderSettings.defaults = {
        account: 'test',
        region: 'us-east-1',
      };
