      ...
      <div className="container-fluid form-horizontal">
        ...
        <div className="form-group">
          <div className="col-md-5 sm-label-right">
            ...
            <HelpField id="tencent.serverGroup.base64UserData" />
          </div>
          <div className="col-md-6">
        ...
        <div className="form-group">
          <div className="col-md-5 sm-label-right">
            ...
            <HelpField id="tencent.serverGroup.securityService" />
          </div>
        ...
        <div className="form-group">
          <div className="col-md-5 sm-label-right">
            ...
            <HelpField id="tencent.serverGroup.instanceMonitoring" />
          </div>
        ...
        <div className="form-group">
          <div className="sm-label-left">
            <b>Tags (optional)</b>
            <HelpField id="tencent.serverGroup.tags" />
          </div>
