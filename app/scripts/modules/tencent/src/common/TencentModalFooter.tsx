...
export interface ITencentModalFooterProps {
  account: string;
  isValid?: boolean;
  onCancel: () => void;
  onSubmit: () => void;
...
export interface ITencentModalFooterState {
  verified: boolean;
  requireVerification: boolean;
}

export class TencentModalFooter extends React.Component<ITencentModalFooterProps, ITencentModalFooterState> {
  public static defaultProps: Partial<ITencentModalFooterProps> = {
    isValid: true,
  };
