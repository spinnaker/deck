...
describe('Service: InstanceType', function() {
  beforeEach(function() {
    window.module(require('./tencentInstanceType.service').name);
  });

  beforeEach(
    window.inject(function(_tencentInstanceTypeService_, _$httpBackend_) {
      this.tencentInstanceTypeService = _tencentInstanceTypeService_;
  ...
  describe('getAllTypesByRegion', function() {
    it('returns types, indexed by region', function() {
      ...
      var results = null;
      this.tencentInstanceTypeService.getAllTypesByRegion().then(function(result) {
        results = result;
      });
  ...
  describe('getAvailableTypesForRegions', function() {
    it('returns results for a single region', function() {
      ...
      var results = null,
        service = this.tencentInstanceTypeService;
    ...
    it('filters instance types by VPC and virtualization type', function() {
      ...
      let service = this.tencentInstanceTypeService;
