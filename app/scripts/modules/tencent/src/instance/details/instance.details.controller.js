...
import { TENCENT_INSTANCE_WRITE_SERVICE } from 'tencent/instance/tencent.instance.write.service';

module.exports = angular
  .module('spinnaker.tencent.instance.details.controller', [
    require('@uirouter/angularjs').default,
    require('angular-ui-bootstrap'),
    TENCENT_INSTANCE_WRITE_SERVICE,
    ...
    function(
      ...
      this.terminateInstance = function terminateInstance() {
        ...
        var submitMethod = function() {
          return tencentInstanceWriter.terminateInstance(instance, app, {
      ...
      this.terminateInstanceAndShrinkServerGroup = function terminateInstanceAndShrinkServerGroup() {
        ...
        var submitMethod = function() {
          return tencentInstanceWriter.terminateInstanceAndShrinkServerGroup(instance, app, {
      ...
      this.rebootInstance = function rebootInstance() {
        ...
        var submitMethod = (params = {}) => {
          ...
          return tencentInstanceWriter.rebootInstance(instance, app, params);
        };
      ...
      this.registerInstanceWithLoadBalancer = function registerInstanceWithLoadBalancer() {
        ...
        var submitMethod = function() {
          return tencentInstanceWriter.registerInstanceWithLoadBalancer(instance, app);
        };
      ...
      this.deregisterInstanceFromLoadBalancer = function deregisterInstanceFromLoadBalancer() {
        ...
        var submitMethod = function() {
          return tencentInstanceWriter.deregisterInstanceFromLoadBalancer(instance, app);
        };
      ...
      this.registerInstanceWithTargetGroup = function registerInstanceWithTargetGroup() {
        ...
        var submitMethod = function() {
          return tencentInstanceWriter.registerInstanceWithTargetGroup(instance, app);
        };
      ...
      this.deregisterInstanceFromTargetGroup = function deregisterInstanceFromTargetGroup() {
        ...
        var submitMethod = function() {
          return tencentInstanceWriter.deregisterInstanceFromTargetGroup(instance, app);
        };
      ...
      this.enableInstanceInDiscovery = function enableInstanceInDiscovery() {
        ...
        var submitMethod = function() {
          return tencentInstanceWriter.enableInstanceInDiscovery(instance, app);
        };
      ...
      this.disableInstanceInDiscovery = function disableInstanceInDiscovery() {
        ...
        var submitMethod = function() {
          return tencentInstanceWriter.disableInstanceInDiscovery(instance, app);
        };
