...
import { TencentLoadBalancerDataUtils } from 'tencent/loadBalancer/tencentLoadBalancerDataUtils';
import { ITencentServerGroup, ITargetGroup } from 'tencent/domain';
...
export interface ITencentLoadBalancersTagState {
  loadBalancers: ILoadBalancer[];
  targetGroups: ITargetGroup[];
  isLoading: boolean;
}

export class TencentLoadBalancersTag extends React.Component<ILoadBalancersTagProps, ITencentLoadBalancersTagState> {
  ...
  public componentDidMount(): void {
    ...
    TencentLoadBalancerDataUtils.populateTargetGroups(this.props.application, this.props
      .serverGroup as ITencentServerGroup).then((targetGroups: ITargetGroup[]) => {
      if (this.mounted) {
  ...
  public render(): React.ReactElement<TencentLoadBalancersTag> {
