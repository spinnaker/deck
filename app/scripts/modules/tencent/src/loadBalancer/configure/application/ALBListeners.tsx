...
export class ALBListeners extends React.Component<IALBListenersProps, IALBListenersState>
  ...
  private listenerProtocolChanged(listener: IListenerDescription, newProtocol: CLBListenerProtocol): void {
  ...
  private certificateTypeChanged(certificate: ICLBListenerCertificate, newType: string): void {
                      ...
                      <div>
                        <span className="wizard-pod-content">
                          ...
                          <select
                            ...
                            onChange={event =>
                              this.listenerProtocolChanged(listener, event.target.value as CLBListenerProtocol)
                            }
                          >
