...
export interface ITencentCertificateSelectFieldProps {
  certificates: { [accountName: string]: ITencentCertificate[] };
  accountName: string;
  currentValue: string;
...
@Overridable('tencent.certificateSelectField')
export class TencentCertificateSelectField extends React.Component<ITencentCertificateSelectFieldProps> {
  public render() {
