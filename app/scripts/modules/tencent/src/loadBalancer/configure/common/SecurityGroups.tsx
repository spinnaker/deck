...
export class SecurityGroups extends React.Component<ISecurityGroupsProps, ISecurityGroupsState>
  ...
  constructor(props: ISecurityGroupsProps) {
    ...
    const defaultSecurityGroups = get<string[]>(TENCENTProviderSettings, 'defaultSecurityGroups', []);
    this.state = {
  ...
  public validate(values: { securityGroups: { length: any } }): FormikErrors<ITencentLoadBalancerUpsertCommand> {
