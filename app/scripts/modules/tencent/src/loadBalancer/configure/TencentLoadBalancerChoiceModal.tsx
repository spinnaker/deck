...
import { ITencentLoadBalancerConfig, LoadBalancerTypes } from './LoadBalancerTypes';

export interface ITencentLoadBalancerChoiceModalState {
  choices: ITencentLoadBalancerConfig[];
  selectedChoice: ITencentLoadBalancerConfig;
}

export class TencentLoadBalancerChoiceModal extends React.Component<
  ILoadBalancerModalProps,
  ITencentLoadBalancerChoiceModalState
> {
  ...
  public static show(props: ILoadBalancerModalProps): Promise<void> {
    return ReactModal.show(TencentLoadBalancerChoiceModal, {
      ...props,
  ...
  public choiceSelected(choice: ITencentLoadBalancerConfig): void {
