...
import { TencentCertificateReader } from 'tencent/certificates/TencentCertificateReader';
import { TencentCertificateSelectField } from '../common/TencentCertificateSelectField';

import './Listeners.less';

export interface IListenersProps {
  formik: FormikProps<ITencentClassicLoadBalancerUpsertCommand>;
  app: Application;
}

export interface IListenersState {
  certificates: { [accountId: number]: ITencentCertificate[] };
}
...
export class Listeners extends React.Component<IListenersProps, IListenersState> {
  ...
  private loadCertificates(): void {
    TencentCertificateReader.listCertificates().then((certificates: any) => {
