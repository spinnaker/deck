...
import { ITencentClassicLoadBalancerUpsertCommand } from 'tencent/domain';
...
export class AdvancedSettings extends React.Component<IAdvancedSettingsProps> {
  public render() {
    ...
    return (
      <div className="form-group TencentLoadBalancer-AdvancedSettings">
        <FormikFormField
          name="healthTimeout"
          label="Timeout"
          required={true}
