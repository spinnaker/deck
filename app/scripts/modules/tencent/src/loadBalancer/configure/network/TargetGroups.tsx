...
export class TargetGroups extends React.Component<ITargetGroupsProps, ITargetGroupsState>
  ...
  public validate(
    ...
    const duplicateTargetGroups = uniq(
      flatten(filter(groupBy(values.targetGroups, 'name'), count => count.length > 1)).map(
        (tg: INLBTargetGroupDescription) => tg.name,
      ),
    );
      ...
      <div className="container-fluid form-horizontal">
        <div className="form-group">
          <div className="col-md-12">
            {values.targetGroups.map((targetGroup: INLBTargetGroupDescription, index: number) => {
