...
import { ITencentApplicationLoadBalancer, ITencentNetworkLoadBalancerUpsertCommand } from 'tencent/domain';

export interface ITargetGroupsProps {
  app: Application;
  formik: FormikProps<ITencentNetworkLoadBalancerUpsertCommand>;
  isNew: boolean;
...
export class TargetGroups extends React.Component<ITargetGroupsProps, ITargetGroupsState>
  implements IWizardPageComponent<ITencentNetworkLoadBalancerUpsertCommand> {
  ...
  public validate(
    values: ITencentNetworkLoadBalancerUpsertCommand,
  ): FormikErrors<ITencentNetworkLoadBalancerUpsertCommand> {
    const errors = {} as any;
  ...
  protected updateLoadBalancerNames(props: ITargetGroupsProps): void {
    ...
    Observable.fromPromise(app.getDataSource('loadBalancers').refresh(true))
      ...
      .subscribe(() => {
        app.getDataSource('loadBalancers').data.forEach((lb: ITencentApplicationLoadBalancer) => {
                  ...
                  <div>
                    ...
                    <div className="wizard-pod-row">
                      <div className="wizard-pod-row-title">
                        <HelpField id="tencent.targetGroup.targetType" /> <span>Target Type&nbsp;</span>
                      </div>
                      <div className="wizard-pod-row-contents">
                        <div className="wizard-pod-row-data">
                      ...
                      <div className="wizard-pod-row-contents">
                        <div className="wizard-pod-row-data">
                          <span className="wizard-pod-content">
                            ...
                            <HelpField id="tencent.targetGroup.protocol" />{' '}
                            <select
                          ...
                          <span className="wizard-pod-content">
                            <label>Port </label>
                            <HelpField id="tencent.targetGroup.port" />{' '}
                            <input
                              className="form-control input-sm inline-number"
                      ...
                      <div className="wizard-pod-row-contents">
                        <div className="wizard-pod-row-data">
                          <span className="wizard-pod-content">
                            ...
                            <HelpField id="tencent.targetGroup.attributes.deregistrationDelay" />{' '}
                            <input
                              className="form-control input-sm inline-number"
                              type="text"
