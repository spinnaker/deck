...
import { ITargetSelectProps } from 'core/pipeline/config/TargetSelect';
...
import { StagePlatformHealthOverrideWrapperDirective } from 'core/pipeline/config/health/stagePlatformHealthOverrideWrapper.directive';
...
import { TargetSelectWrapperComponent } from 'core/pipeline/config/targetSelectWrapper.component';
...
import { IStagePlatformHealthOverrideProps } from 'core/pipeline/config/health/StagePlatformHealthOverride';
...
export class NgReactInjector extends ReactInject {
  ...
  public StagePlatformHealthOverride: React.ComponentClass<IStagePlatformHealthOverrideProps>   = angular2react('stagePlatformHealthOverride', new StagePlatformHealthOverrideWrapperDirective(), this.$injectorProxy) as any;
  ...
  public TargetSelect: React.ComponentClass<ITargetSelectProps>                                 = angular2react('targetSelectWrapper', new TargetSelectWrapperComponent(), this.$injectorProxy) as any;
