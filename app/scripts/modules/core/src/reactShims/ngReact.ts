...
import { INumberListProps, NumberList as NumberListComponent } from 'core/forms/numberList/NumberList';
...
export class NgReactInjector extends ReactInject {
  ...
  public NumberList: React.FunctionComponent<INumberListProps> = NumberListComponent;
