...
const helpContents: { [key: string]: string } = {
  ...
  'pipeline.config.webhook.successStatuses':
    'Comma-separated list of strings (that will be returned in the response body) that will be considered as SUCCESS status.',
  'pipeline.config.webhook.canceledStatuses':
    'Comma-separated list of strings (that will be returned in the response body) that will be considered as CANCELED status.',
  'pipeline.config.webhook.terminalStatuses':
    'Comma-separated list of strings (that will be returned in the response body) that will be considered as TERMINAL status.',
