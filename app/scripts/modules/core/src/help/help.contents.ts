...
const helpContents: { [key: string]: string } = {
  ...
  'pipeline.config.expectedArtifact.defaultGitlab.reference': `
      ...
      <p>An example is <code>https://gitlab.com/api/v4/projects/$PROJECTID/repository/files/path%2Fto%2Ffile.yml/raw</code>. See <a href="https://www.spinnaker.io/reference/artifacts/types/gitlab-file/#fields">our docs</a> for more info.</p>`,
