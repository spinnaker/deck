        ...
        describe(name, () => {
          it('finds instance within server group (' + name + ')', () => {
            ...
            serverGroups[2].instances = [
              { uid: 'in-1', id: 'in-1', health: null, launchTime: 1, zone: null },
              { uid: 'in-2', id: 'in-2', health: null, launchTime: 1, zone: null },
            ];
            serverGroups[4].instances = [
              { uid: 'in-3', id: 'in-3', health: null, launchTime: 1, zone: null },
              { uid: 'in-2', id: 'in-2', health: null, launchTime: 1, zone: null },
            ];
            application.runningTasks.data = [
              buildTask({
