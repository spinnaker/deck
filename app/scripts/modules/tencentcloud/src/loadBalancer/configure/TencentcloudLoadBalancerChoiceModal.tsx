...
import { ILoadBalancerModalProps, ModalClose, ReactModal, noop, ILoadBalancerUpsertCommand } from '@spinnaker/core';
...
> {
  ...
  private choose = (): void => {
    ...
    this.state.selectedChoice.component
      ...
      .then(loadBalancer => {
        this.props.closeModal((loadBalancer as unknown) as ILoadBalancerUpsertCommand);
      })
      .catch(() => {});
  };
