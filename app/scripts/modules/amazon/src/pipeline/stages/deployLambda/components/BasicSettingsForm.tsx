    ...
    <div>
      ...
      <FormikFormField
        ...
        input={(props: IFormInputProps) => (
          <ReactSelectInput {...props} stringOptions={availableRuntimes} clearable={true} />
        )}
      />
      <FormikFormField
        name="s3bucket"
        ...
        input={(props: IFormInputProps) => <TextInput {...props} placeholder="S3 bucket name" />}
      />
      <FormikFormField
        name="s3key"
        label="S3 Key"
        help={<HelpField id="aws.function.s3key" />}
        input={(props: IFormInputProps) => <TextInput {...props} placeholder="object.zip" />}
      />
      <FormikFormField
        name="handler"
        label="Handler"
        help={<HelpField id="aws.function.handler" />}
        input={(props: IFormInputProps) => <TextInput {...props} placeholder="filename.method" />}
      />
      <FormikFormField
        name="publish"
        label="Publish"
