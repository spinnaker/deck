...
async function createRule() {
  ...
  await replaceInFile(`template/template-name.ts`, `rules/${rulename}.ts`, /RULENAME/g, rulename);
  await replaceInFile(`template/template-name.spec.ts`, `rules/${rulename}.test.ts`, /RULENAME/g, rulename);
  await insertAfter('eslint-plugin.js', `\n    '${rulename}': require('${rulename}'),`, 'rules: {');
