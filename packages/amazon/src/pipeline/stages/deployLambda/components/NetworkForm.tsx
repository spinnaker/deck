...
import { FormikFormField, NetworkReader, ReactInjector, ReactSelectInput, SubnetReader, TetheredSelect, useData } from '@spinnaker/core';
...
export function NetworkForm( props: IFormikStageConfigInjectedProps ) {
  ...
  const { result: fetchSubnetsResult} = useData(
